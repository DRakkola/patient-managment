# Generated by Django 3.2.1 on 2021-06-09 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allerg_4', models.CharField(blank=True, max_length=255, null=True)),
                ('allerg_5', models.CharField(blank=True, max_length=255, null=True)),
                ('allerg_6', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pediatri_1', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, unique=True)),
                ('Details', models.CharField(default='rights details', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('bio', models.CharField(blank=True, max_length=500, null=True)),
                ('Group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.usergroups')),
                ('Rights', models.ManyToManyField(blank=True, to='accounts.UserRights')),
